...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <h3 class="font-italic col-blue">Liste des utilisateurs</h3>
            <p>Votre liste des utilisateurs enregistrés dans l'application</p>
            <a href="{{route('compte-create')}}"><button class="btn btn-secondary pull-right" style="margin-top:-65px;margin-right:20px;border-radius:50px;width:130px;height:50px;color:white;background-color:blue;font-size:20px;" ><i class="material-icons">add</i>Ajouter</button></a>
            <!-- Basic Examples -->
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('compte-destroy',$user->id) }}" method="POST">
                                                        ...
                                                        <a class="btn btn-info" href="{{route('compte-show',$user->id)}}">Profil</a>
                                                        @if($user->etat()->first()->nom == "actif")
                                                            <a class="btn btn-danger" href="{{route('compte-bloquer',$user->id)}}">Bloquer</a>
                                                        @endif
                                                        @if($user->etat()->first()->nom == "bloquer")
                                                            <a class="btn btn-primary" href="{{route('compte-activer',$user->id)}}">Activer</a>
                                                        @endif
                                                        @csrf
                                                        @method('DELETE')
                                                        @can('delete-action')
