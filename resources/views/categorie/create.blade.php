    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h3 class="font-italic col-blue">Enregistrement de categories</h3>
                        ...
                        <div class="body">
                            <form action="{{ route('categorie-store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="nom" name="nom"  class="form-control" placeholder="Entrer le nom de la categorie" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="pourcentageRepassage" id="pourcentageRepassage" class="form-control" required>
                                    </div>
                                </div>
                                <br>
