...
<body class="theme-indigo">
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li >
                                <a href="{{ route('categorie-all') }}" style="color:rgb(63, 81, 196);">Liste categorie</a>
                            </li>
                            <li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <h3 class="font-italic col-blue">Liste de categories</h3>
            <p>Votre liste de categories enregistrée dans l'application</p>
            <a href="{{route('categorie-create')}}"><button class="btn btn-secondary pull-right" style="margin-top:-65px;margin-right:20px;border-radius:50px;width:130px;height:50px;color:white;background-color:blue;font-size:20px;" ><i class="material-icons">add</i>Ajouter</button></a>
            <!-- Basic Examples -->
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td>{{$categorie->pourcentageRepassage}}%</td>
                                                <td>
                                                    <form action="{{ route('categorie-destroy',$categorie->id) }}" method="POST">

                                                        <a class="btn btn-success" href="{{route('categorie-edit',$categorie->id)}}">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
                                                        @can('delete-action')
