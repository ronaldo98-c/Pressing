    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h3 class="font-italic col-blue">Detail sur la categorie</h3>
                <p>Corrigez les details sur le client et cliquez sur modifier.</p>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('categorie-update',$categorie->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="prix" id="prix" value="{{$categorie->prix}}" class="form-control" required/>
                                </div>
                                <label for="pourcentageRepassage">Pourcentage repassage</label>
                                <div class="form-group">
                                    <input type="text" name="pourcentageRepassage" id="pourcentageRepassage" value="{{$categorie->pourcentageRepassage}}" class="form-control" required/>
                                </div>
                                <br>
