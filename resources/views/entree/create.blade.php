...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <h3 class="font-italic col-blue">Enregistrement de vêtements </h3>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        @endif
                        <div class="body">
                            <form action="{{ route('entree-store',$client->id) }}" method="POST">
                                @csrf
                                <label>Type</label>
                                ...
                                <label for="pu"  id="pu">Prix du kg de vêtement</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="pu" id="pu" class="form-control" placeholder="Entrer pu du vêtement">
                                    </div>
                                </div>
                                <label for="poids" id="poids">Poids</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="poids"  id="poids" class="form-control" placeholder="Entrer le poids du vêtement">
                                    </div>
                                </div>
                                <label for="prixRepassage"  id="prixRepassage">Prix de repassage par vêtement</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="prixRepassage" id="prixRepassage" class="form-control" placeholder="Entrer pu par vêtement">
                                    </div>
                                </div>
                                <br>
                                <button type="submit" class="btn btn-primary m-t-15 waves-effect" onclick="return confirm('Êtes-vous sûre de votre choix?');">ENREGISTRER</button>
                            </form>
                        </div>
                    </div>
                </div>
