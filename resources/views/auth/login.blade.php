...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><img src="images/logo.jpg" alt=""></a>
            <small>PRESSING-MANAGMENT</small>
            ...
            <div class="body">
                <form method="POST" action="{{ route('login-user') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <button class="btn btn-block bg-indigo waves-effect" type="submit">CONNECTER</button>
                        </div>
                    </div>
                </form>
            </div>
