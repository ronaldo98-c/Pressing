    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h3 class="font-italic col-blue">Detail sur le client</h3>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('client-update',$client->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="telephone" id="telephone" value="{{$client->telephone}}" class="form-control" required/>
                                </div>
                                    ...
                                    <div class="form-line">
                                        <select id="remise"  name="remise" class="form-control">
                                          @if(isset($client->remise))
                                            <option>{{$client->remise->taux}}</option>
                                          @endif
                                          <option></option>
                                          @if(count($remises) > 0)
