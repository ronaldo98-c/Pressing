    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h3 class="font-italic col-blue">Communiquer avec vos clients</h3>
                <p>Saisissez les informations et cliquez sur envoyer</p>
            </div>
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        @endif
                        <div class="body">
                            <label for="telephone">Contact(s)</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="telephone" id="telephone" disabled class="form-control">
                                </div>
                            </div>
                            <label for="message">Message</label>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Saisissez le message" id="message"></textarea>
                            </div>
                            <input type="text" style="display:none;" value="{{$pressing->nom}}" id="nomPressing">
                            <button type="button" class="btn btn-primary m-t-15 waves-effect" onClick="userAction()">ENVOYER</button>
                        </div>
                    </div>
                </div>
            </div>
