...
<body class="theme-indigo">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('sortieRemi-all') }}" style="color:rgb(63, 81, 196);">Vêtements remis</a>
                            </li>
                            <li>
    ...
    <section class="content">
        <div class="container-fluid">
            <h3 class="font-italic col-blue">Liste de vêtements remis</h3>
            <p>Cliquer sur detail pour plus d'informations.</p>
            <!-- Basic Examples -->
