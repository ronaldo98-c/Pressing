            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('update-detail',$detail->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <label for="quantite">Quantite</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="quantite" name="quantite"value="{{$detail->quantite}}"  class="form-control" required>
                                    </div>
                                </div>
                                <label for="marque">Marque</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="marque" id="marque"value="{{$detail->marque}}" class="form-control" required>
                                    </div>
                                </div>
                                <label for="couleur">Couleur</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="couleur" id="couleur"value="{{$detail->couleur}}" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select id="categorie"  name="categorie" class="form-control" required>
                                            <option>{{$detail->categorie->nom}}</option>
                                ...
                                @if($detail->entree->prixRepassage == null)
                                <label for="choix">Inclu le repassage</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <select id="choix"  name="choix" class="form-control" required>
                                          <option>{{$detail->repassage}}</option>
