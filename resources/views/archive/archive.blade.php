...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <h3 class="font-italic col-blue">Archives genérales</h3>
            <p>Cliquer sur une ligne pour plus d'informations.</p>
            <!-- Exportable Table -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-href="{{route('archive-show',$entree->id)}}">
                                                <td>{{$entree->id}}</td>
    ...
    <script src="../../js/pages/tables/verifier.js"></script>
    <!-- Demo Js -->
