...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <h3 class="font-italic col-blue">Liste de remises</h3>
            <p>Votre liste de remises enregistrée dans l'application</p>
            <a href="{{ route('remise-create') }}"><button class="btn btn-secondary pull-right" style="margin-top:-65px;margin-right:20px;border-radius:50px;width:130px;height:50px;color:white;background-color:blue;font-size:20px;" ><i class="material-icons">add</i>Ajouter</button></a>
            <!-- Basic Examples -->
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('remise-destroy',$remise->id) }}" method="POST">
                                                        <a class="btn btn-success" href="{{route('remise-edit',$remise->id)}}">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
                                                        @can('delete-action')
