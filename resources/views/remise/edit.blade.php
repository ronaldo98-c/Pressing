            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('remise-update',$remise->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <label for="taux">Taux</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="taux" name="taux" value="{{$remise->taux}}" class="form-control" required>
                                    </div>
                                </div>
                                <label for="description">Description</label>
                                <div class="form-group">
                                    <textarea name="description" id="description"  class="form-control" required>{{$remise->description}}</textarea>
                                </div>
                                <br>
